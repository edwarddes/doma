    ...
    $allScripts = array(
      ...
      array("version" => "2.1",
            "scripts" => array(
              ...
              "ALTER TABLE `". DB_MAP_TABLE ."` CHANGE `Name` `Name` varchar(50) character set utf8 collate $collation NOT NULL, CHANGE `Organiser` `Organiser` varchar(50) character set utf8 collate $collation NOT NULL, CHANGE `Country` `Country` varchar(20) character set utf8 collate $collation NOT NULL, CHANGE `Discipline` `Discipline` varchar(40) character set utf8 collate $collation NOT NULL, CHANGE `RelayLeg` `RelayLeg` varchar(10) character set utf8 collate $collation NOT NULL, CHANGE `MapName` `MapName` varchar(50) character set utf8 collate $collation NOT NULL, CHANGE `ResultListUrl` `ResultListUrl` text character set utf8 collate $collation NOT NULL, CHANGE `MapImage` `MapImage` varchar(100) character set utf8 collate $collation NOT NULL, CHANGE `ThumbnailImage` `ThumbnailImage` varchar(100) character set utf8 collate $collation NOT NULL",
